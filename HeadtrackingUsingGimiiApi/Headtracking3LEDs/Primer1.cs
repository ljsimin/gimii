...
namespace Headtracking3LEDs
{
    public partial class Primer1 : Form
    {
        ...
        private Vector3 pogledVektor = new Vector3(0f , 0f, -1f); //vektor pogleda pocinje se pogledom duz z osu

        private Vector3 goreVektor = new Vector3(0f, 1f, 0f); //vektor koji odredjuje sta je gore u sceni
        ...
        private void PostaviKameru()
        {
            ...
            uredjaj.Transform.View = Matrix.LookAtLH(polozajGlave, Vector3.Add(pogledVektor, polozajGlave), goreVektor);
            ...
            if (e.KeyCode == Keys.Insert)
            {
                if (povezan == false)
                {
                    ...
                    if (rekorderPolozaja == null)
                    {
                        ...
                        //Kontroler w = WiiFabrika.dobaviInstancu().kreirajKontroler(@"d:\My documents\kacket3");
                        rekorderPolozaja = new WiiRekorderPolozaja(PracenjeGlaveTip.PRACENJE_3_IZVORA, w, razmakDiodaMM, udaljenostPrednjeDiodeMM, visinaEkranaMM, kontrolerIznadEkrana);
        ...
        private void ReakcijaNaPromenu(PolozajGlave args)
        {
            if (args.Uspesno)
            {
               ...
               pogledVektor.X = args.PogledVektor.X;
               pogledVektor.Y = args.PogledVektor.Y;
               pogledVektor.Z = args.PogledVektor.Z;
                ...
                goreVektor.X = args.GoreVektor.X;
                goreVektor.Y = args.GoreVektor.Y;
                goreVektor.Z = args.GoreVektor.Z;
